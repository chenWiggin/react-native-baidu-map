package org.lovebing.reactnative.activity;
...
/**
 * Created by 909929 on 2018/5/30.
 */
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new BNRouteGuideManager.CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.popup), BNRouteGuideManager.CustomizedLayerItem.ALIGN_CENTER);
            items.add(item1);
